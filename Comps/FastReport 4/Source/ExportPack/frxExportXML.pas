...
uses frxUtils, frxFileUtils, frxUnicodeUtils, frxRes, frxrcExports,ShellAPI;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        WriteExpLn('</Borders>');
        if (EStyle.DisplayFormat.Kind = fkNumeric) then
        begin
          if (EStyle.DisplayFormat.FormatStr <> '%2.2n') and
            ...
            WriteExpLn('<NumberFormat ss:Format="Fixed"/>');
        end;
        WriteExpLn('</Style>');
      end;
      WriteExpLn('</Styles>');
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                if not obj.Style.HideZeros or (s <> '') then
                begin
