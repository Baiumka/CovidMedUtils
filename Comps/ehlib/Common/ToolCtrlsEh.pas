...
{*******************************************************}
{============== Changes by Vadim ========================
#1  04.08.2010 add to Enabled to TEditButtonEh
}
{$I EhLib.Inc}
...
{ TEditButtonEh }
  ...
  published
    ...
    property Enabled: Boolean read FEnabled write SetEnabled default True; {#1}
...
type
  ...
  TGetItemsListEh = procedure(Sender: TObject; Items: TStrings) of object;
...
function CompareList(List: TStringList; Index1,
...
procedure TBMListEh.Sort;
begin
  //FList.CustomSort(CompareList);
  FList.Sort;
end;
